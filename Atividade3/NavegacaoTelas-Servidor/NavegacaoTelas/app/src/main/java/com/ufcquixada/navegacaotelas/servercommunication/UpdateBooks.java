...
public class UpdateBooks extends Thread {

    MainActivity activity;
    ExpandableListView expandableListView;
    Book book;

    public UpdateBooks( MainActivity activity, ExpandableListView expandableListView, Book book ) {
    ...
    public void run() {
        String stringURL = "http://192.168.1.67:3333/books" + "/" + String.valueOf(book.getId());
